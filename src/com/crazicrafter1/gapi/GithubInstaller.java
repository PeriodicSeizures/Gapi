...
class GithubInstaller {
    ...
    static boolean installDepend(final Plugin main, String author, String githubProject, String jarname, String dependName) {
        try {
            ...
            }.run() ;//.runTaskLaterAsynchronously(main, 0);
            return true;
